export function Project({ project }) {
  return (
    <>
      <div class='bg-white rounded-xl lg:w-3/4 p-6 flex flex-col  items-center justify-center gap-4 transition-all lg:odd:flex-row-reverse lg:flex-row  shadow-lg '>
        <img
          src={project?.img}
        ...
        <div class='h-full items-start justify-center lg:w-1/2 text-center gap-4'>
          <h4
            class={` font-bold text-xl lg:text-2xl mb-4 ${project?.textColor}`}>
            {project?.title}
          </h4>
          ...
          <div class='flex justify-center items-center mt-6 w-full gap-x-6 font-semibold'>
            <a href='code' class='flex gap-x-2 hover:scale-105 transition-all'>
              <img src='/github.svg' class=' h-6 w-6' />
              Code
            </a>
            <a href='demo' class='flex gap-x-2 hover:scale-105 transition-all'>
